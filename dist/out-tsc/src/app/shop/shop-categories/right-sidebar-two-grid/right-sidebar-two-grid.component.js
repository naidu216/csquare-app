...
let RightSidebarTwoGridComponent = class RightSidebarTwoGridComponent {
...
RightSidebarTwoGridComponent = tslib_1.__decorate([
    Component({
        selector: 'app-right-sidebar-two-grid',
        templateUrl: './right-sidebar-two-grid.component.html',
        styleUrls: ['./right-sidebar-two-grid.component.scss']
    }),
    tslib_1.__metadata("design:paramtypes", [ActivatedRoute, Router,
        ProductsService])
], RightSidebarTwoGridComponent);
export { RightSidebarTwoGridComponent };
//# sourceMappingURL=right-sidebar-two-grid.component.js.map