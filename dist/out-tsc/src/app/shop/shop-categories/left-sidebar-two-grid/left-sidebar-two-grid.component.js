...
let LeftSidebarTwoGridComponent = class LeftSidebarTwoGridComponent {
...
LeftSidebarTwoGridComponent = tslib_1.__decorate([
    Component({
        selector: 'app-left-sidebar-two-grid',
        templateUrl: './left-sidebar-two-grid.component.html',
        styleUrls: ['./left-sidebar-two-grid.component.scss']
    }),
    tslib_1.__metadata("design:paramtypes", [ActivatedRoute, Router,
        ProductsService])
], LeftSidebarTwoGridComponent);
export { LeftSidebarTwoGridComponent };
//# sourceMappingURL=left-sidebar-two-grid.component.js.map