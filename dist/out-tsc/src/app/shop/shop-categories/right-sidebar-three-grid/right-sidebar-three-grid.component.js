...
let RightSidebarThreeGridComponent = class RightSidebarThreeGridComponent {
...
RightSidebarThreeGridComponent = tslib_1.__decorate([
    Component({
        selector: 'app-right-sidebar-three-grid',
        templateUrl: './right-sidebar-three-grid.component.html',
        styleUrls: ['./right-sidebar-three-grid.component.scss']
    }),
    tslib_1.__metadata("design:paramtypes", [ActivatedRoute, Router,
        ProductsService])
], RightSidebarThreeGridComponent);
export { RightSidebarThreeGridComponent };
//# sourceMappingURL=right-sidebar-three-grid.component.js.map