...
let ImageStickyComponent = class ImageStickyComponent {
...
ImageStickyComponent = tslib_1.__decorate([
    Component({
        selector: 'app-image-sticky',
        templateUrl: './image-sticky.component.html',
        styleUrls: ['./image-sticky.component.scss']
    }),
    tslib_1.__metadata("design:paramtypes", [ActivatedRoute, Router,
        ProductsService, WishListService,
        CartService, NgbModal])
], ImageStickyComponent);
export { ImageStickyComponent };
//# sourceMappingURL=image-sticky.component.js.map